    ...
    <table class="table table-striped">
      ...
      <table class="table pull-right table-striped" style="width:400px;">
        ...
        <tr>
          ...
          <td>
            <a class="btn btn-medium btn-primary" href="<?php if ($host == "localhost" || $host == "dev.babybeddingtown.com") {echo MCHN_ROOT . "checkout.php";} else {echo "https://www.babybeddingtown.com/checkout.php";}?>"><small>CHECKOUT</small></a>
          </td>
        </tr>
      </table>
