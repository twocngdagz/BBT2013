<div class="">
	...
	<table class="flexbrands"></table>
	<div class="clear"><br /></div>
    <a href="#modal-create-brands" role="button" class="btn btn-success" data-toggle="modal">Create New Brand</a>
</div>
	...
	<form action="./brands" method="post" enctype="multipart/form-data">
		<div class="modal-header">
		  ...
		  <div class="modal-footer">
		    <input type="hidden" name="d[brand_id]" value="" id="brand-id"/>
...
$(document).ready(function() {
	$(".flexbrands").flexigrid({
		url : 'core/view/grid/brands.php',
		dataType : 'json',
		colModel : [ 
	...
	$('.flexbrands').click(function(event){
	    $('.trSelected', this).each( function(){
	        ...
	        $('#brand-id').attr('value', $(this).attr('id').substr(3));
	    	$('#delete').show();
